...
class OrderTableViewController: UITableViewController {
    ...
    @IBAction func submitTapped(_ sender: Any) {
        ...
        let alertController = UIAlertController(title: "Confirm Order", message: "You are about to submit you order with a total of \(formattedTotal)", preferredStyle: .actionSheet)
    ...
    func configure(_ cell: UITableViewCell, forItemAt indexPath: IndexPath) {
        ...
        imageLoadTasks[indexPath] = Task.init {
            if let image = try? await MenuController.shared.fetchImage(fron: menuItem.imageURL) {
